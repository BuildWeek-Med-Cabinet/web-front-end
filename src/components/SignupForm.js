            ...
            <form className='form2 container' onSubmit={onSubmit}>
                ...
                <div className='form-group inputs'>
                    <div style={{margin:'20px 0', padding: '0px'}}>
                        <label>Username&nbsp;
                            <input  style={{margin:'0', padding: '0px'}}
                    ...
                    <div style={{margin:'20px 0', padding: '0px'}}>
                        <label style={{margin:'0', padding: '0px'}}>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div>
                        <button style={{padding:'5px 10px', margin:'10px 50%'}}disabled={disabled}>submit</button>
                    </div>
                </div>
            </form>
        </div>
